...
//                                    Admin Portion for Adding Doctors
...
// using stack to push doctor information
void
...
struct blood
{
  ...
  struct blood *next;
										...
										//Adding Blood Donors manually by Admin
	  ...
	  if (strcmp (ptr->bloodgroup, blood_group) == 0 && ptr->RH == rh_factor)
		{
		  ...
		  // Found matching donor, so return immediately
		}
	  ptr = ptr->next;
	}
}
